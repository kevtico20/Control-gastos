...
const diccionartiosIconos = {
    ...
    gastos: IconoGastos,
    gustos: IconoOcio,
    suspcripcion: IconoSuscripciones
}
const Gasto = ({ gasto, setGastoEditar, eliminarGasto }) => {
    const { seleccionar, nombre, cantidad, id, fecha } = gasto;
            ...
            >
                <div className="gasto sombra">
                    <div className="contenido-gasto">
                        <img src={diccionartiosIconos[seleccionar]} alt="Icono Gasto" />
                        <div className="descripcion-gasto">
                            <p className="categoria"> {seleccionar}</p>
